...
use std::sync::Arc;
use crate::core::config::siddhi_app_context::SiddhiAppContext; // For init context
...
pub trait DataSource: Debug + Send + Sync + 'static { // 'static for Arc<dyn DataSource>
    ...
    fn init(&mut self, siddhi_app_context: &Arc<SiddhiAppContext>, data_source_id: &str, config: DataSourceConfig) -> Result<(), String>;
