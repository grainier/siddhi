...
impl Default for Operator {
    fn default() -> Self { Operator::Equal } // Defaulting to Equal, could be any.
}
...
impl Compare {
    pub fn new(left_expression: Expression, operator: Operator, right_expression: Expression) -> Self {
        Compare {
