...
use super::math::{Add, Subtract, Multiply, Divide, ModOp};
...
impl Expression {
    // Constants
    pub fn value_string(value: String) -> Self { Expression::Constant(Constant::string(value)) }
    pub fn value_int(value: i32) -> Self { Expression::Constant(Constant::int(value)) }
    pub fn value_long(value: i64) -> Self { Expression::Constant(Constant::long(value)) }
    pub fn value_double(value: f64) -> Self { Expression::Constant(Constant::double(value)) }
    pub fn value_float(value: f32) -> Self { Expression::Constant(Constant::float(value)) }
    pub fn value_bool(value: bool) -> Self { Expression::Constant(Constant::bool(value)) }

    // Variable
    pub fn variable(attribute_name: String) -> Self { Expression::Variable(Variable::new(attribute_name)) }
    ...
    // Math
    pub fn add(left: Expression, right: Expression) -> Self { Expression::Add(Box::new(Add::new(left, right))) }
    pub fn subtract(left: Expression, right: Expression) -> Self { Expression::Subtract(Box::new(Subtract::new(left, right))) }
    pub fn multiply(left: Expression, right: Expression) -> Self { Expression::Multiply(Box::new(Multiply::new(left, right))) }
    pub fn divide(left: Expression, right: Expression) -> Self { Expression::Divide(Box::new(Divide::new(left, right))) }
    pub fn modulus(left: Expression, right: Expression) -> Self { Expression::Mod(Box::new(ModOp::new(left, right))) }
    ...
    pub fn and(left: Expression, right: Expression) -> Self { Expression::And(Box::new(And::new(left, right))) }
    pub fn or(left: Expression, right: Expression) -> Self { Expression::Or(Box::new(Or::new(left, right))) }
    pub fn not(expr: Expression) -> Self { Expression::Not(Box::new(Not::new(expr))) }
    ...
    pub fn is_null_stream(stream_id: String, stream_index: Option<i32>, is_inner: bool, is_fault: bool) -> Self {
        Expression::IsNull(Box::new(IsNull::new_with_stream_details(stream_id, stream_index, is_inner, is_fault)))
    }

    // Time constants
    pub fn time_millisec(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::millisec(val)) }
    pub fn time_sec(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::sec(val)) }
    pub fn time_minute(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::minute(val)) }
    pub fn time_hour(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::hour(val)) }
    pub fn time_day(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::day(val)) }
    pub fn time_week(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::week(val)) }
    pub fn time_month(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::month(val)) }
    pub fn time_year(val: i64) -> Self { Expression::Constant(ConstantTimeUtil::year(val)) }
}
...
impl Expression {
    ...
    pub fn set_query_context_start_index(&mut self, index: Option<(i32, i32)>) {
        match self {
            ...
            Expression::AttributeFunction(af) => af.siddhi_element.query_context_start_index = index,
